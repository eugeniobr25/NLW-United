...
import rocketseat.com.passin.domain.attende.Attendee;
...
public class EventService {
    ...
    public EventeIdDTO createEvent(EventRequestDTO eventDTO){
        ...
        return new EventeIdDTO(newEvent.getId());
    }
    ...
    private Event getEventById(String eventId){
        return this.eventRepository.findById(eventId).orElseThrow(() -> new EventeNotFoundException("Event not found with ID: " + eventId));
    }
